 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      This is a modification of Eder Porto's drawing in POV-Ray. This       *
 *      version has a plane drawn behind the knot, resulting in a shadow cast *
 *      on it. This is significantly slower than the version without the      *
 *      shadows. Render options used:                                         *
